...
Arguments:
  KNXD_VERSION    Version of knxd to build (default: 0.14.75)
...
Examples:
  ...
  IMAGE_NAME=my-knxd $0 0.14.75

  # Multi-platform build and push
  REGISTRY=myregistry.com/myuser PUSH=true PLATFORMS=linux/amd64,linux/arm64 $0 0.14.75
...
if ! [[ "$KNXD_VERSION" =~ ^[0-9]+\.[0-9]+\.[0-9]+$ ]]; then
    ...
    log_info "Expected format: x.y.z (e.g., 0.14.75)"
    exit 1
fi
